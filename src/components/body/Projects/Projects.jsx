    ...
    return(
        <StyledProjects>
            ...
            <div>
                ...
                <ProjectCard logo={api} text="K-Imóveis" link="https://github.com/RafaFreitasDev/kimoveis-nodejs"/>
                <ProjectCard logo={api} text="Rede Social" link="https://github.com/RafaFreitasDev/projetobackend-redesocial"/>
            </div>
