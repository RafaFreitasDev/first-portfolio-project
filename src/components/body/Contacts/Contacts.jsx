...
export const Contacts = () => {
    ...
    return(
        <StyledContact>
            ...
            {lang=="port"?<ContactCardLink logo={curriculo} text="Currículo" link="https://drive.google.com/file/d/1eyoyus1ykbsTUrsIRUUtx44GdKlkLVpN/view?usp=sharing"/>:<ContactCardLink logo={curriculo} text="Resume" link="https://drive.google.com/file/d/1EoWM-1fsjfJoqI9AtQaDu1lUXKqtMWtP/view?usp=sharing"/>}
        </StyledContact>
    )
}