...
export const Contacts = () => {
    ...
    return(
        <StyledContact>
            ...
            {lang=="port"?<ContactCardLink logo={curriculo} text="Currículo" link="https://drive.google.com/file/d/1jOVgxAztlOGj2Vxhy1kAFqEAVuwGxZ54/view?usp=sharing"/>:<ContactCardLink logo={curriculo} text="Resume" link="https://drive.google.com/file/d/1OU31ZyWv7sABqPXzDQaryzi6iKE80w7H/view?usp=sharing"/>}
        </StyledContact>
    )
}